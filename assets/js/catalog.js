/*
  ...
  - status: "new" (nuovo arrivo), "in" (disponibile), "out" (esaurito).
*/
window.BL_STORE = {
  phone: "+393756795995",
...
window.BL_CATALOG = [
  { n: 1,  name: "Hockey Jersey Black District", variant: "Heather / White", brand: "Cianotic Archive", cat: "maglie", price: null, sizes: [], ground: "grey",  status: "new", img: "assets/img/ig/p01.jpg" },
  { n: 2,  name: "Hoodie Blessed 17",             variant: "Strass all over",  brand: "",                 cat: "felpe",  price: null, sizes: [], ground: "grey",  status: "new", img: "assets/img/ig/p02.jpg" },
  { n: 3,  name: "Hockey Jersey Black District", variant: "Black / White",   brand: "Cianotic Archive", cat: "maglie", price: null, sizes: [], ground: "grey",  status: "new", img: "assets/img/ig/p03.jpg" },
  ...
  { n: 8,  name: "Giacca Denim Hood",             variant: "Raw blue, zip",    brand: "",                 cat: "giacche",price: null, sizes: [], ground: "black", status: "new", img: "assets/img/ig/p08.jpg" },
  ...
  { n: 12, name: "Jeans Patch Camo",              variant: "Black wash + camo", brand: "",                cat: "jeans",  price: null, sizes: [], ground: "black", status: "new", img: "assets/img/ig/p12.jpg" }
];
